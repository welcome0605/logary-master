  ...
  return (
    <DocPage name="all-target" title="FAQs" faIcon={faLifeRing} colour="green" readingMinutes={2} toc={toc}>
      ...
      <DocSection {...toc[3]}>
        ...
        <p>Inspect the version specified in the Logary package and ensure that you have that exact version installed. Hopac is currently pre-v1 so it is often doing breaking changes between versions.</p>
      </DocSection>
    </DocPage>
  )
}
