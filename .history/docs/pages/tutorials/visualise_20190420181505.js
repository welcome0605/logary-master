  ...
  return (
    <DocPage name="js-quickstart" title="Tutorials" faIcon={faFileChartLine} colour="primary" readingMinutes={3} toc={toc}>
      ...
      <DocSection {...toc[3]}>
        <h2 className="section-title">Namespace guidelines – <span className="_code"> Logary.Internals </span>or not</h2>
        <p></p>
        <p>The <span className="_code"> RuntimeInfo </span> and internal Logger should be propagated to the modules and objects that you build your solution out of. This guideline is mostly about the registry's implementation and its interaction with config and services.</p>
      </DocSection>
    </DocPage>
  )
}