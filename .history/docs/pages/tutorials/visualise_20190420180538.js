  ...
  return (
    <DocPage name="js-quickstart" title="Tutorials" faIcon={faFileChartLine} colour="primary" readingMinutes={3} toc={toc}>
      ...
      <DocSection {...toc[0]}>
        ...
        <ul>
          <li>Logary – core namespace</li>
          <li>Metrics – namespace for all metrics implementations</li>
          <li>Ticked – a module and/or type that implements Logary-based ticking/ scheduling.</li>
        </ul>
