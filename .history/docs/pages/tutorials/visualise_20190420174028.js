...
import { faFileChartLine } from '@fortawesome/free-brands-svg-icons';
...
export default function Tutorials() {
  ...
  return (
    <DocPage name="js-quickstart" title="JavaScript Quickstart" faIcon={faFileChartLine} colour="primary" readingMinutes={2} toc={toc}>
      <Head>
