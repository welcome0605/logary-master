  ...
  return (
    <DocPage name="js-quickstart" title="Tutorials" faIcon={faFileChartLine} colour="primary" readingMinutes={3} toc={toc}>
      ...
      <DocSection {...toc[0]}>
        ...
        <p>Declare your interfaces in a <span className="_code"></span> MyIf.fs and its module in MyIfModule.fs with a [<CompilationRepresentation(CompilationRepresentationFlags.ModuleSuffix)>].</p>
