...
export default function DotnetDocs() {
  const toc =
    ...
    { id: "support", title: "support", ref: useRef(null) },]
  ...
  return (
    <DocPage name=".net-documentation" title=".Net Core Documentation" faIcon={faBooks} colour="purple" readingMinutes={2} toc={toc}>
      ...
      <DocSection {...toc[3]}>
        ...
        <p>
          <a href="https://developers.redhat.com/topics/dotnet/">Red Hat supports .NET Core</a> on Red Hat Enterprise Linux (RHEL). Red Hat builds .NET Core from source and makes it available in the <a href="https://developers.redhat.com/products/softwarecollections/overview/">Red Hat Software Collections.</a>
