...
export default function Targets() {
  ...
  return (
    <DocPage name="all-target" title="Target / Sinks" faIcon={faPuzzlePiece} colour="pink" readingMinutes={2} toc={toc}>
      ...
      <DocSection {...toc[4]}>
        <p>
          Target for <a href="Microsoft Azure AppInsights"> Microsoft Azure AppInsights </a> logs the events as TRACE-messages (or Events/Metrics with a different
           MappingConfiguration). You need to set the API-key first. Then when you go to Azure Portal Application Insights and 
           Overview -> Search you should be able to find the targets from there. Metrics goes to Metrics Explorer -> Add Chart -> 
           Custom. More info...
        </p>
      </DocSection>
    </DocPage>
