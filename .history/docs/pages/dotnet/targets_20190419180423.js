      ...
      <DocSection {...toc[4]}>
        <p>
          Target for <a href="https://docs.microsoft.com/en-us/azure/azure-monitor/overview"> Microsoft Azure AppInsights </a> logs the events as TRACE-messages (or Events/Metrics with a different
           ...
           <span className="_code"> Overview -> Search </span> you should be able to find the targets from there. Metrics goes to Metrics Explorer -> Add Chart -> 
           Custom. <a href="https://docs.microsoft.com/en-us/azure/azure-monitor/app/create-new-resource">More info...</a> 
        </p>
      </DocSection>
    </DocPage>
  )
