...
`helm upgrade --debug --install rutta && \\
    ...
    --values values/rutta.yaml`
      ...
      <DocSection {...toc[6]}>
        ...
        <p>Shippers CONNECT PUSH sockets to the Router's PULL socket. See http://lists.zeromq.org/pipermail/zeromq-dev/2012-February/015917.html</p>
        <p>During network splits, the sending PUSH socket blocks.</p>
      </DocSection>
      <DocSection {...toc[7]}>
